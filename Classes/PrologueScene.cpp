...
bool PrologueScene::init()
{
    ...
    _messageArray = Array::create(
                                  ccs("宇宙のどこかにある、名前のない小さな惑星。そこに、『君』はたったひとりで暮らしています。"),
                                  ccs("そんなある日、空から轟音と共に何かが落ちてきました。"),
                                  ccs("『君』が恐る恐る近づいてみるとーー。"),
                                  ccs("「……ここはどこでしょう？」"),
                                  ccs("それは突然動き出し、『君』に尋ねたのです。"),
                                  ccs("突然落ちてきた美少女VOY∀GERと共に、『君』は地球へ向かうこととなりました。"),
                                  ccs("しかしVOY∀GERは壊れており、直前の記録しか残っていません。"),
                                  ccs("「道のりを逆に辿ることで、もしかしたらデータが復元されるかも…」"),
                                  ccs("その言葉通り、旅路を逆戻りしながら『君』が様々な質問を重ねることで、VOY∀GERは少しずつデータを取り戻していくのです。"),
                                  ccs("画面をタップして次へ…"),
                                  NULL);
